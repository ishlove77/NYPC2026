...
static int P_HP_RATIO_TRAIN_PRIORITY_X_NUM = 1;   /* MoE runtime param */
#define HP_RATIO_TRAIN_PRIORITY_X_NUM P_HP_RATIO_TRAIN_PRIORITY_X_NUM
#endif
#ifndef HP_RATIO_TRAIN_PRIORITY_X_DEN
static int P_HP_RATIO_TRAIN_PRIORITY_X_DEN = 6;   /* MoE runtime param */
...
static int P_OPENING_NEUTRAL_FIRST_MAX_TURN = 97;   /* MoE runtime param */
...
static int P_ENDGAME_SYNC_ARRIVAL_TURN = 190;   /* MoE runtime param */
...
static int P_ENABLE_FORWARD_STAGING = 0;   /* MoE runtime param */
...
static int P_HARD_DEFENSE_SKIPS_ECONOMY_MOVES = 0;   /* MoE runtime param */
...
static int P_STACK_DANGER_COUNT = 3;   /* MoE runtime param */
#define STACK_DANGER_COUNT P_STACK_DANGER_COUNT
#endif
#ifndef STACK_LOOKAHEAD
static int P_STACK_LOOKAHEAD = 12;   /* MoE runtime param */
...
static int P_STACK_CLEANUP_MAX_TARGET_ETA = 8;   /* MoE runtime param */
...
static int P_STACK_CLEANUP_EXTRA_MARGIN = 4;   /* MoE runtime param */
...
static int P_RETREAT_MAX_UNITS = 228;   /* MoE runtime param */
...
static int P_ENABLE_NO_DRIP_ATTACK = 1;   /* MoE runtime param */
...
static int P_ANCHOR_ROUTE_KEEP_EXTRA_AT_SOURCE = 5;   /* MoE runtime param */
...
static int P_ANCHOR_ROUTE_START_BASES_A_DEN = 2;   /* MoE runtime param */
...
static int P_ANCHOR_ROUTE_BUILD_CAPTURED_FIRST = 0;   /* MoE runtime param */
#define ANCHOR_ROUTE_BUILD_CAPTURED_FIRST P_ANCHOR_ROUTE_BUILD_CAPTURED_FIRST
#endif
#ifndef ANCHOR_ROUTE_RETURN_AFTER_CAPTURE
static int P_ANCHOR_ROUTE_RETURN_AFTER_CAPTURE = 1;   /* MoE runtime param */
...
static int P_MAX_CAPTURE_SIM_DAYS = 83;   /* MoE runtime param */
#define MAX_CAPTURE_SIM_DAYS P_MAX_CAPTURE_SIM_DAYS
#endif
#ifndef HQ_SIM_MAX_REINFORCE_DAYS
static int P_HQ_SIM_MAX_REINFORCE_DAYS = 41;   /* MoE runtime param */
...
static int P_CASH_DUMP_TRAIN_START_TURN = 116;   /* MoE runtime param */
#define CASH_DUMP_TRAIN_START_TURN P_CASH_DUMP_TRAIN_START_TURN
#endif
#ifndef CASH_DUMP_MIN_GOLD
static int P_CASH_DUMP_MIN_GOLD = 837;   /* MoE runtime param */
...
static int P_FINAL_HQ5_HARD_DUMP_START_TURN = 198;   /* MoE runtime param */
...
static int P_FINAL_HQ5_MIN_TRAIN_GOLD = 235;   /* MoE runtime param */
...
static int P_OWNED_BASE_CRISIS_SIM_DAYS = 24;   /* MoE runtime param */
...
static int P_HQ_SIM_DEFENSE_DAYS = 22;   /* MoE runtime param */
#define HQ_SIM_DEFENSE_DAYS P_HQ_SIM_DEFENSE_DAYS
#endif
#ifndef HQ_SIM_DEFENSE_MAX_RECALL
static int P_HQ_SIM_DEFENSE_MAX_RECALL = 16;   /* MoE runtime param */
...
static int P_FALLBACK_MAX_PULL = 2;   /* MoE runtime param */
#define FALLBACK_MAX_PULL P_FALLBACK_MAX_PULL
#endif
#ifndef FALLBACK_TRAIN_CAP
static int P_FALLBACK_TRAIN_CAP = 0;   /* MoE runtime param */
...
/* ===== MoE expert routing (user 2026-07-06): params by map size =====
   ...
   expert 0: gen=4 fit=0.8443 scores={'m85052': 0.83, 'm83616': 0.84, 'P2': 0.96, 'a23sub': 0.9, 'g15off': 0.98, 'rush2': 0.89, 'center2': 0.51}
   expert 1: gen=7 fit=0.8214 scores={'m85052': 0.8, 'm83616': 0.77, 'P2': 1.0, 'a23sub': 0.86, 'g15off': 0.98, 'rush2': 0.73, 'center2': 0.61}
   expert 2: gen=26 fit=0.8029 scores={'m85052': 0.76, 'm83616': 0.76, 'P2': 0.96, 'a23sub': 0.86, 'g15off': 0.97, 'rush2': 0.7, 'center2': 0.61}
   expert 3: gen=25 fit=0.83 scores={'m85052': 0.77, 'm83616': 0.79, 'P2': 0.94, 'a23sub': 0.86, 'g15off': 0.98, 'rush2': 0.79, 'center2': 0.68}
*/
static int g_moe_expert = -1;
static void moe_apply_expert_params(int N) {
  int e = (N <= 63) ? 0 : (N <= 79) ? 1 : (N <= 93) ? 2 : 3;
  g_moe_expert = e;
  { static const int t[4] = {215, 215, 215, 178}; P_BUILD_RESERVE = t[e]; }
  { static const int t[4] = {10, 0, 0, 0}; P_EXPANSION_MOVE_RESERVE = t[e]; }
  { static const int t[4] = {1, 1, 0, 0}; P_ENABLE_ENEMY_BASE_CAPTURE = t[e]; }
  { static const int t[4] = {1, 1, 1, 0}; P_ENABLE_ENEMY_HQ_ATTACK = t[e]; }
  { static const int t[4] = {3, 3, 3, 3}; P_NORMAL_EXTRA_GARRISON = t[e]; }
  { static const int t[4] = {95, 97, 84, 123}; P_OPENING_NEUTRAL_FIRST_MAX_TURN = t[e]; }
  { static const int t[4] = {90, 90, 90, 82}; P_OPENING_NEUTRAL_FIRST_TARGET_PERCENT = t[e]; }
  { static const int t[4] = {14, 14, 14, 11}; P_OPENING_NEUTRAL_FIRST_MIN_TARGETS = t[e]; }
  { static const int t[4] = {10, 10, 12, 19}; P_OPENING_NEUTRAL_FIRST_MAX_TARGETS = t[e]; }
  { static const int t[4] = {59, 54, 39, 48}; P_OPENING_RELAX_HQ_KEEP_UNTIL_TURN = t[e]; }
  { static const int t[4] = {30, 30, 30, 30}; P_OPENING_DELAY_HQ_UPGRADE_UNTIL_TURN = t[e]; }
  { static const int t[4] = {5, 6, 0, 3}; P_OPENING_DELAY_HQ_UPGRADE_MIN_HANDLED = t[e]; }
  { static const int t[4] = {111, 119, 120, 119}; P_OPENING_FORCE_ONE_NEUTRAL_PER_TURN_UNTIL = t[e]; }
  { static const int t[4] = {42, 42, 42, 30}; P_OPENING_FORCE_TRAIN_NEUTRAL_UNTIL = t[e]; }
  { static const int t[4] = {53, 53, 41, 46}; P_THIN_OPENING_MAX_TURN = t[e]; }
  { static const int t[4] = {5, 4, 6, 5}; P_THIN_OPENING_RUSH_SAFETY_TURNS = t[e]; }
  { static const int t[4] = {10, 10, 9, 10}; P_OPENING_NEUTRAL_ABORT_ENEMY_MASS_ETA = t[e]; }
  { static const int t[4] = {10, 10, 10, 7}; P_OPENING_NEUTRAL_ABORT_ENEMY_MASS = t[e]; }
  { static const int t[4] = {18, 17, 17, 17}; P_ENDGAME_ATTACK_TURNS = t[e]; }
  { static const int t[4] = {116, 47, 47, 47}; P_ENDGAME_GOLD_SAFETY = t[e]; }
  { static const int t[4] = {172, 172, 183, 172}; P_ENDGAME_SYNC_START_TURN = t[e]; }
  { static const int t[4] = {150, 190, 150, 150}; P_ENDGAME_SYNC_ARRIVAL_TURN = t[e]; }
  { static const int t[4] = {1, 0, 1, 0}; P_ENABLE_FORWARD_STAGING = t[e]; }
  { static const int t[4] = {3, 3, 3, 2}; P_FORWARD_STAGING_MAX_PER_SOURCE = t[e]; }
  { static const int t[4] = {9, 9, 2, 9}; P_FORWARD_STAGING_EXTRA_CAP = t[e]; }
  ...
  { static const int t[4] = {6, 6, 5, 6}; P_DEFENSE_HARD_ETA = t[e]; }
  { static const int t[4] = {0, 0, 0, 2}; P_DEFENSE_RECALL_EXTRA = t[e]; }
  { static const int t[4] = {0, 0, 1, 0}; P_HARD_DEFENSE_SKIPS_ECONOMY_MOVES = t[e]; }
  { static const int t[4] = {5, 5, 5, 5}; P_DEFENSE_KEEP_EXTRA_WORKERS = t[e]; }
  { static const int t[4] = {1, 0, 0, 1}; P_ENABLE_STACK_ONLY_GUARD = t[e]; }
  { static const int t[4] = {5, 3, 4, 4}; P_STACK_DANGER_COUNT = t[e]; }
  { static const int t[4] = {10, 12, 8, 12}; P_STACK_LOOKAHEAD = t[e]; }
  { static const int t[4] = {2, 2, 5, 1}; P_STACK_TARGET_DANGER_COUNT = t[e]; }
  { static const int t[4] = {1, 1, 0, 0}; P_ENABLE_STACK_ONLY_CLEANUP = t[e]; }
  { static const int t[4] = {2, 2, 2, 2}; P_STACK_CLEANUP_MIN_ENEMY = t[e]; }
  { static const int t[4] = {10, 8, 7, 10}; P_STACK_CLEANUP_MAX_TARGET_ETA = t[e]; }
  { static const int t[4] = {5, 5, 5, 2}; P_STACK_CLEANUP_RATIO_NUM = t[e]; }
  { static const int t[4] = {1, 1, 1, 1}; P_STACK_CLEANUP_RATIO_DEN = t[e]; }
  { static const int t[4] = {3, 4, 0, 3}; P_STACK_CLEANUP_EXTRA_MARGIN = t[e]; }
  { static const int t[4] = {5, 5, 5, 5}; P_STACK_CLEANUP_MIN_WAVE = t[e]; }
  { static const int t[4] = {0, 0, 4, 2}; P_STACK_CLEANUP_MAX_SEND_EXTRA = t[e]; }
  { static const int t[4] = {0, 0, 0, 0}; P_ENABLE_INITIAL_SYNC_CAPTURE = t[e]; }
  { static const int t[4] = {0, 1, 1, 1}; P_ENABLE_NO_DRIP_ATTACK = t[e]; }
  { static const int t[4] = {5, 5, 5, 5}; P_MIN_ATTACK_WAVE_UNITS = t[e]; }
  { static const int t[4] = {1, 1, 0, 0}; P_ENABLE_STRICT_SAME_ETA_ATTACK_WAVE = t[e]; }
  { static const int t[4] = {76, 75, 75, 75}; P_RALLY_STACK_STAGE_START_TURN = t[e]; }
  { static const int t[4] = {141, 141, 130, 141}; P_RALLY_STACK_HQ_ATTACK_START_TURN = t[e]; }
  { static const int t[4] = {4, 4, 4, 4}; P_RALLY_STACK_MIN_LAUNCH_UNITS = t[e]; }
  { static const int t[4] = {24, 26, 23, 11}; P_RALLY_STACK_MAX_STAGE_MOVES_PER_TURN = t[e]; }
  { static const int t[4] = {1, 1, 1, 1}; P_RALLY_STACK_KEEP_AT_RALLY = t[e]; }
  { static const int t[4] = {6, 6, 5, 5}; P_HQ_SAVE_LOOKAHEAD_TURNS = t[e]; }
  { static const int t[4] = {1, 1, 1, 1}; P_BASE_DUMMY_HP_DIV = t[e]; }
  { static const int t[4] = {92, 83, 89, 86}; P_MAX_CAPTURE_SIM_DAYS = t[e]; }
  { static const int t[4] = {104, 41, 104, 68}; P_HQ_SIM_MAX_REINFORCE_DAYS = t[e]; }
  { static const int t[4] = {152, 152, 152, 152}; P_LATE_TIEBREAK_START_TURN = t[e]; }
  { static const int t[4] = {20, 20, 44, 28}; P_LATE_TIEBREAK_SAVE_LOOKAHEAD_TURNS = t[e]; }
  { static const int t[4] = {122, 116, 123, 122}; P_CASH_DUMP_TRAIN_START_TURN = t[e]; }
  { static const int t[4] = {899, 837, 1087, 899}; P_CASH_DUMP_MIN_GOLD = t[e]; }
  { static const int t[4] = {169, 169, 169, 174}; P_FINAL_HQ5_CASH_DUMP_START_TURN = t[e]; }
  { static const int t[4] = {195, 198, 195, 195}; P_FINAL_HQ5_HARD_DUMP_START_TURN = t[e]; }
  { static const int t[4] = {97, 235, 97, 129}; P_FINAL_HQ5_MIN_TRAIN_GOLD = t[e]; }
  { static const int t[4] = {7, 1, 7, 7}; P_HP_RATIO_TRAIN_PRIORITY_X_NUM = t[e]; }
  { static const int t[4] = {1, 6, 1, 9}; P_HP_RATIO_TRAIN_PRIORITY_X_DEN = t[e]; }
  { static const int t[4] = {2, 2, 2, 2}; P_HP_RATIO_TRAIN_PRIORITY_MIN_ENEMY_HP = t[e]; }
  { static const int t[4] = {106, 121, 121, 127}; P_HP_RATIO_TRAIN_PRIORITY_MAX_TURN = t[e]; }
  { static const int t[4] = {2, 2, 2, 1}; P_HP_RATIO_TRAIN_PRIORITY_MAX_PER_TURN = t[e]; }
  { static const int t[4] = {1, 1, 1, 1}; P_OWNED_BASE_CRISIS_RELEASE_RADIUS = t[e]; }
  { static const int t[4] = {21, 24, 20, 22}; P_OWNED_BASE_CRISIS_SIM_DAYS = t[e]; }
  { static const int t[4] = {16, 16, 5, 5}; P_OWNED_BASE_MAX_EMERGENCY_PULL = t[e]; }
  { static const int t[4] = {14, 14, 13, 10}; P_OWNED_BASE_REINFORCE_SOURCE_RADIUS = t[e]; }
  { static const int t[4] = {49, 49, 55, 49}; P_RETREAT_SIM_DAYS = t[e]; }
  { static const int t[4] = {218, 228, 227, 233}; P_RETREAT_MAX_UNITS = t[e]; }
  { static const int t[4] = {112, 112, 191, 133}; P_ANCHOR_ROUTE_START_TURN = t[e]; }
  { static const int t[4] = {3, 3, 3, 3}; P_ANCHOR_ROUTE_ANCHOR_MODE = t[e]; }
  { static const int t[4] = {16, 14, 14, 13}; P_ANCHOR_ROUTE_MAX_STAGE_PER_TURN = t[e]; }
  { static const int t[4] = {0, 5, 0, 0}; P_ANCHOR_ROUTE_KEEP_EXTRA_AT_SOURCE = t[e]; }
  { static const int t[4] = {21, 20, 21, 20}; P_ANCHOR_ROUTE_MAX_STACK = t[e]; }
  { static const int t[4] = {9, 9, 9, 9}; P_ANCHOR_ROUTE_LEAVE_AT_ANCHOR = t[e]; }
  { static const int t[4] = {1, 1, 0, 0}; P_ANCHOR_ROUTE_USE_ONLY_BASE_ANCHOR = t[e]; }
  { static const int t[4] = {30, 30, 20, 30}; P_ANCHOR_ROUTE_MIN_ATTACKERS = t[e]; }
  { static const int t[4] = {3, 3, 1, 13}; P_ANCHOR_ROUTE_MIN_OWNED_BASES_TO_ATTACK = t[e]; }
  { static const int t[4] = {1, 1, 0, 2}; P_ANCHOR_ROUTE_START_BASES_A_NUM = t[e]; }
  { static const int t[4] = {3, 2, 2, 8}; P_ANCHOR_ROUTE_START_BASES_A_DEN = t[e]; }
  { static const int t[4] = {0, 0, 1, 1}; P_ANCHOR_ROUTE_START_BASES_B = t[e]; }
  { static const int t[4] = {7, 7, 7, 7}; P_ANCHOR_ROUTE_LEAVE_ON_CAPTURE = t[e]; }
  { static const int t[4] = {1, 0, 0, 0}; P_ANCHOR_ROUTE_BUILD_CAPTURED_FIRST = t[e]; }
  { static const int t[4] = {0, 1, 0, 0}; P_ANCHOR_ROUTE_RETURN_AFTER_CAPTURE = t[e]; }
  { static const int t[4] = {1, 0, 0, 1}; P_ANCHOR_ROUTE_STICKY_ANCHOR = t[e]; }
  { static const int t[4] = {1, 1, 1, 1}; P_HQ_SIM_DEFENSE_THREAT_RADIUS = t[e]; }
  { static const int t[4] = {25, 22, 20, 25}; P_HQ_SIM_DEFENSE_DAYS = t[e]; }
  { static const int t[4] = {24, 16, 11, 11}; P_HQ_SIM_DEFENSE_MAX_RECALL = t[e]; }
  { static const int t[4] = {1, 1, 1, 1}; P_HQ_SIM_DEFENSE_TRAIN_CAP = t[e]; }
  { static const int t[4] = {1, 1, 1, 0}; P_BASE_SIM_DEFENSE_THREAT_RADIUS = t[e]; }
  { static const int t[4] = {3, 2, 3, 5}; P_FALLBACK_MAX_PULL = t[e]; }
  { static const int t[4] = {1, 0, 1, 1}; P_FALLBACK_TRAIN_CAP = t[e]; }
  { static const int t[4] = {1, 1, 1, 1}; P_HQ_DONOR_KEEP = t[e]; }
  { static const int t[4] = {-2, -2, -2, -2}; P_ARMY_PARITY_MARGIN = t[e]; }
  { static const int t[4] = {0, 0, 0, 0}; P_ARMY_PARITY_EXPANSION_SLACK = t[e]; }
  { static const int t[4] = {1, 1, 1, 1}; P_PARITY_MAX_OPP_CAP_RATIO = t[e]; }
  { static const int t[4] = {1, 1, 1, 2}; P_OWNED_BASE_RESCUE_EXTRA = t[e]; }
}
