/* species2b champion gen33 (job 1275469, 82804-base run).
   In-run scores (150 games/gate): vsP2 0.920, g15off 0.930, a23 rush 0.817
   (best rush margin since gen 20; all gates PASS). NOT yet 1000-game
   verified. Lineage: 82804 economy + GA defense; sibling of verified
   gen17 (0.767/0.885/0.925) and gen32 (0.771/0.902/0.915). */
...
#define EXPANSION_MOVE_RESERVE 10
#endif
#ifndef ENABLE_ENEMY_BASE_CAPTURE
#define ENABLE_ENEMY_BASE_CAPTURE 0
#endif
...
#define NORMAL_EXTRA_GARRISON 0
#endif
...
#define OPENING_NEUTRAL_FIRST_MAX_TURN 75
#endif
#ifndef OPENING_NEUTRAL_FIRST_TARGET_PERCENT
#define OPENING_NEUTRAL_FIRST_TARGET_PERCENT 84
#endif
#ifndef OPENING_NEUTRAL_FIRST_MIN_TARGETS
#define OPENING_NEUTRAL_FIRST_MIN_TARGETS 10
#endif
...
#define OPENING_RELAX_HQ_KEEP_UNTIL_TURN 46
#endif
#ifndef OPENING_DELAY_HQ_UPGRADE_UNTIL_TURN
#define OPENING_DELAY_HQ_UPGRADE_UNTIL_TURN 2
#endif
...
#define OPENING_FORCE_ONE_NEUTRAL_PER_TURN_UNTIL 98
#endif
#ifndef OPENING_FORCE_TRAIN_NEUTRAL_UNTIL
#define OPENING_FORCE_TRAIN_NEUTRAL_UNTIL 71
#endif
...
#define THIN_OPENING_MAX_TURN 55
#endif
#ifndef THIN_OPENING_RUSH_SAFETY_TURNS
#define THIN_OPENING_RUSH_SAFETY_TURNS 5
#endif
...
#define OPENING_NEUTRAL_ABORT_ENEMY_MASS_ETA 15
#endif
...
#define ENDGAME_SYNC_ARRIVAL_TURN 181
#endif
...
#define FORWARD_STAGING_EXTRA_CAP 10
#endif
...
#define STACK_DANGER_COUNT 2
#endif
#ifndef STACK_LOOKAHEAD
#define STACK_LOOKAHEAD 6
#endif
...
#define RETREAT_SIM_DAYS 104
#endif
#ifndef RETREAT_MAX_UNITS
#define RETREAT_MAX_UNITS 206
#endif
...
#define MIN_ATTACK_WAVE_UNITS 3
#endif
...
#define ANCHOR_ROUTE_START_TURN 137
#endif
...
#define ANCHOR_ROUTE_MIN_ATTACKERS 22
#endif
...
#define ANCHOR_ROUTE_LEAVE_ON_CAPTURE 1
#endif
...
#define HQ_SAVE_LOOKAHEAD_TURNS 3
#endif
...
#define MAX_CAPTURE_SIM_DAYS 75
#endif
#ifndef HQ_SIM_MAX_REINFORCE_DAYS
#define HQ_SIM_MAX_REINFORCE_DAYS 92
#endif
...
#define LATE_TIEBREAK_START_TURN 168
#endif
#ifndef LATE_TIEBREAK_SAVE_LOOKAHEAD_TURNS
#define LATE_TIEBREAK_SAVE_LOOKAHEAD_TURNS 36
#endif
...
#define CASH_DUMP_TRAIN_START_TURN 134
#endif
#ifndef CASH_DUMP_MIN_GOLD
#define CASH_DUMP_MIN_GOLD 1269
#endif
...
#define FINAL_HQ5_CASH_DUMP_START_TURN 175
#endif
...
#define FINAL_HQ5_MIN_TRAIN_GOLD 216
#endif
...
static int issue_hq_surplus_anchor_pressure(Actions *a,
  ...
  int target = -1, rally = -1;
  if (!choose_rally_stack_target_and_base(S, M, P, a, allow_hq_target, &target, &rally)) return 0;
  ...
  int did = 0;
  int limit = min_int(HQ_SURPLUS_ANCHOR_MAX_MOVES_PER_TURN, movable);
...
#define OWNED_BASE_CRISIS_SIM_DAYS 28
#endif
...
#define ENABLE_UNSAVABLE_BASE_FALLBACK 0
#endif
