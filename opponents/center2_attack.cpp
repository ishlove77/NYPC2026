...
static int P_BUILD_RESERVE = 215;   /* MoE runtime param */
#define BUILD_RESERVE P_BUILD_RESERVE
#endif
#ifndef EXPANSION_MOVE_RESERVE
static int P_EXPANSION_MOVE_RESERVE = 0;   /* MoE runtime param */
#define EXPANSION_MOVE_RESERVE P_EXPANSION_MOVE_RESERVE
#endif
#ifndef ENABLE_ENEMY_BASE_CAPTURE
static int P_ENABLE_ENEMY_BASE_CAPTURE = 1;   /* MoE runtime param */
#define ENABLE_ENEMY_BASE_CAPTURE P_ENABLE_ENEMY_BASE_CAPTURE
#endif
#ifndef ENABLE_ENEMY_HQ_ATTACK
static int P_ENABLE_ENEMY_HQ_ATTACK = 1;   /* MoE runtime param */
#define ENABLE_ENEMY_HQ_ATTACK P_ENABLE_ENEMY_HQ_ATTACK
#endif
...
static int P_HP_RATIO_TRAIN_PRIORITY_X_NUM = 7;   /* MoE runtime param */
#define HP_RATIO_TRAIN_PRIORITY_X_NUM P_HP_RATIO_TRAIN_PRIORITY_X_NUM
#endif
#ifndef HP_RATIO_TRAIN_PRIORITY_X_DEN
static int P_HP_RATIO_TRAIN_PRIORITY_X_DEN = 1;   /* MoE runtime param */
#define HP_RATIO_TRAIN_PRIORITY_X_DEN P_HP_RATIO_TRAIN_PRIORITY_X_DEN
#endif
#ifndef HP_RATIO_TRAIN_PRIORITY_MAX_TURN
static int P_HP_RATIO_TRAIN_PRIORITY_MAX_TURN = 121;   /* MoE runtime param */
#define HP_RATIO_TRAIN_PRIORITY_MAX_TURN P_HP_RATIO_TRAIN_PRIORITY_MAX_TURN
#endif
#ifndef HP_RATIO_TRAIN_PRIORITY_MIN_ENEMY_HP
static int P_HP_RATIO_TRAIN_PRIORITY_MIN_ENEMY_HP = 2;   /* MoE runtime param */
#define HP_RATIO_TRAIN_PRIORITY_MIN_ENEMY_HP P_HP_RATIO_TRAIN_PRIORITY_MIN_ENEMY_HP
#endif
#ifndef HP_RATIO_TRAIN_PRIORITY_MAX_PER_TURN
static int P_HP_RATIO_TRAIN_PRIORITY_MAX_PER_TURN = 2;   /* MoE runtime param */
#define HP_RATIO_TRAIN_PRIORITY_MAX_PER_TURN P_HP_RATIO_TRAIN_PRIORITY_MAX_PER_TURN
#endif
...
static int P_NORMAL_EXTRA_GARRISON = 3;   /* MoE runtime param */
#define NORMAL_EXTRA_GARRISON P_NORMAL_EXTRA_GARRISON
#endif
...
static int P_OPENING_NEUTRAL_FIRST_MAX_TURN = 93;   /* MoE runtime param */
#define OPENING_NEUTRAL_FIRST_MAX_TURN P_OPENING_NEUTRAL_FIRST_MAX_TURN
#endif
#ifndef OPENING_NEUTRAL_FIRST_TARGET_PERCENT
static int P_OPENING_NEUTRAL_FIRST_TARGET_PERCENT = 90;   /* MoE runtime param */
#define OPENING_NEUTRAL_FIRST_TARGET_PERCENT P_OPENING_NEUTRAL_FIRST_TARGET_PERCENT
#endif
#ifndef OPENING_NEUTRAL_FIRST_MIN_TARGETS
static int P_OPENING_NEUTRAL_FIRST_MIN_TARGETS = 14;   /* MoE runtime param */
#define OPENING_NEUTRAL_FIRST_MIN_TARGETS P_OPENING_NEUTRAL_FIRST_MIN_TARGETS
#endif
#ifndef OPENING_NEUTRAL_FIRST_MAX_TARGETS
static int P_OPENING_NEUTRAL_FIRST_MAX_TARGETS = 10;   /* MoE runtime param */
#define OPENING_NEUTRAL_FIRST_MAX_TARGETS P_OPENING_NEUTRAL_FIRST_MAX_TARGETS
#endif
...
static int P_OPENING_RELAX_HQ_KEEP_UNTIL_TURN = 54;   /* MoE runtime param */
#define OPENING_RELAX_HQ_KEEP_UNTIL_TURN P_OPENING_RELAX_HQ_KEEP_UNTIL_TURN
#endif
#ifndef OPENING_DELAY_HQ_UPGRADE_UNTIL_TURN
static int P_OPENING_DELAY_HQ_UPGRADE_UNTIL_TURN = 30;   /* MoE runtime param */
#define OPENING_DELAY_HQ_UPGRADE_UNTIL_TURN P_OPENING_DELAY_HQ_UPGRADE_UNTIL_TURN
#endif
#ifndef OPENING_DELAY_HQ_UPGRADE_MIN_HANDLED
static int P_OPENING_DELAY_HQ_UPGRADE_MIN_HANDLED = 6;   /* MoE runtime param */
#define OPENING_DELAY_HQ_UPGRADE_MIN_HANDLED P_OPENING_DELAY_HQ_UPGRADE_MIN_HANDLED
#endif
...
static int P_OPENING_FORCE_ONE_NEUTRAL_PER_TURN_UNTIL = 119;   /* MoE runtime param */
#define OPENING_FORCE_ONE_NEUTRAL_PER_TURN_UNTIL P_OPENING_FORCE_ONE_NEUTRAL_PER_TURN_UNTIL
#endif
#ifndef OPENING_FORCE_TRAIN_NEUTRAL_UNTIL
static int P_OPENING_FORCE_TRAIN_NEUTRAL_UNTIL = 42;   /* MoE runtime param */
#define OPENING_FORCE_TRAIN_NEUTRAL_UNTIL P_OPENING_FORCE_TRAIN_NEUTRAL_UNTIL
#endif
...
#endif
/* 97281-2 center breaker: keep the original split opening, but send a second
   HQ warrior to center immediately and save the first 300g build for center.
   Against the original 97281, which sends only one center contestant and never
   reinforces a live center fight, this creates a deterministic 2v1 at center. */
#ifndef CENTER_SECOND_BASE_DOUBLE_CENTER_OPENING
#define CENTER_SECOND_BASE_DOUBLE_CENTER_OPENING 1
#endif
#ifndef CENTER_SECOND_BASE_DOUBLE_CENTER_TARGET_COUNT
#define CENTER_SECOND_BASE_DOUBLE_CENTER_TARGET_COUNT 2
#endif
#ifndef CENTER_SECOND_BASE_DOUBLE_CENTER_SAVE_GOLD
#define CENTER_SECOND_BASE_DOUBLE_CENTER_SAVE_GOLD 1
#endif
...
static int P_THIN_OPENING_MAX_TURN = 53;   /* MoE runtime param */
#define THIN_OPENING_MAX_TURN P_THIN_OPENING_MAX_TURN
#endif
#ifndef THIN_OPENING_RUSH_SAFETY_TURNS
static int P_THIN_OPENING_RUSH_SAFETY_TURNS = 4;   /* MoE runtime param */
#define THIN_OPENING_RUSH_SAFETY_TURNS P_THIN_OPENING_RUSH_SAFETY_TURNS
#endif
...
static int P_OPENING_NEUTRAL_ABORT_ENEMY_MASS_ETA = 10;   /* MoE runtime param */
#define OPENING_NEUTRAL_ABORT_ENEMY_MASS_ETA P_OPENING_NEUTRAL_ABORT_ENEMY_MASS_ETA
#endif
#ifndef OPENING_NEUTRAL_ABORT_ENEMY_MASS
static int P_OPENING_NEUTRAL_ABORT_ENEMY_MASS = 10;   /* MoE runtime param */
#define OPENING_NEUTRAL_ABORT_ENEMY_MASS P_OPENING_NEUTRAL_ABORT_ENEMY_MASS
#endif
...
static int P_ENDGAME_ATTACK_TURNS = 17;   /* MoE runtime param */
#define ENDGAME_ATTACK_TURNS P_ENDGAME_ATTACK_TURNS
#endif
#ifndef ENDGAME_GOLD_SAFETY
static int P_ENDGAME_GOLD_SAFETY = 47;   /* MoE runtime param */
#define ENDGAME_GOLD_SAFETY P_ENDGAME_GOLD_SAFETY
#endif
#ifndef ENDGAME_SYNC_START_TURN
static int P_ENDGAME_SYNC_START_TURN = 172;   /* MoE runtime param */
#define ENDGAME_SYNC_START_TURN P_ENDGAME_SYNC_START_TURN
#endif
#ifndef ENDGAME_SYNC_ARRIVAL_TURN
static int P_ENDGAME_SYNC_ARRIVAL_TURN = 150;   /* MoE runtime param */
#define ENDGAME_SYNC_ARRIVAL_TURN P_ENDGAME_SYNC_ARRIVAL_TURN
#endif
...
static int P_ENABLE_FORWARD_STAGING = 1;   /* MoE runtime param */
#define ENABLE_FORWARD_STAGING P_ENABLE_FORWARD_STAGING
#endif
#ifndef FORWARD_STAGING_MAX_PER_SOURCE
static int P_FORWARD_STAGING_MAX_PER_SOURCE = 3;   /* MoE runtime param */
#define FORWARD_STAGING_MAX_PER_SOURCE P_FORWARD_STAGING_MAX_PER_SOURCE
#endif
#ifndef FORWARD_STAGING_EXTRA_CAP
static int P_FORWARD_STAGING_EXTRA_CAP = 9;   /* MoE runtime param */
#define FORWARD_STAGING_EXTRA_CAP P_FORWARD_STAGING_EXTRA_CAP
#endif
...
static int P_ENABLE_HOME_DEFENSE = 1;   /* MoE runtime param */
#define ENABLE_HOME_DEFENSE P_ENABLE_HOME_DEFENSE
...
static int P_DEFENSE_SAFETY_MARGIN = 0;   /* MoE runtime param */
#define DEFENSE_SAFETY_MARGIN P_DEFENSE_SAFETY_MARGIN
#endif
#ifndef DEFENSE_IMMEDIATE_RADIUS
static int P_DEFENSE_IMMEDIATE_RADIUS = 1;   /* MoE runtime param */
#define DEFENSE_IMMEDIATE_RADIUS P_DEFENSE_IMMEDIATE_RADIUS
#endif
...
static int P_DEFENSE_HARD_ETA = 6;   /* MoE runtime param */
#define DEFENSE_HARD_ETA P_DEFENSE_HARD_ETA
#endif
#ifndef DEFENSE_RECALL_EXTRA
static int P_DEFENSE_RECALL_EXTRA = 0;   /* MoE runtime param */
#define DEFENSE_RECALL_EXTRA P_DEFENSE_RECALL_EXTRA
#endif
...
static int P_HARD_DEFENSE_SKIPS_ECONOMY_MOVES = 1;   /* MoE runtime param */
#define HARD_DEFENSE_SKIPS_ECONOMY_MOVES P_HARD_DEFENSE_SKIPS_ECONOMY_MOVES
#endif
...
static int P_ENABLE_STACK_ONLY_GUARD = 0;   /* MoE runtime param */
#define ENABLE_STACK_ONLY_GUARD P_ENABLE_STACK_ONLY_GUARD
#endif
#ifndef STACK_DANGER_COUNT
static int P_STACK_DANGER_COUNT = 4;   /* MoE runtime param */
#define STACK_DANGER_COUNT P_STACK_DANGER_COUNT
#endif
#ifndef STACK_LOOKAHEAD
static int P_STACK_LOOKAHEAD = 10;   /* MoE runtime param */
#define STACK_LOOKAHEAD P_STACK_LOOKAHEAD
#endif
#ifndef STACK_TARGET_DANGER_COUNT
static int P_STACK_TARGET_DANGER_COUNT = 2;   /* MoE runtime param */
#define STACK_TARGET_DANGER_COUNT P_STACK_TARGET_DANGER_COUNT
#endif
#ifndef ENABLE_STACK_ONLY_CLEANUP
static int P_ENABLE_STACK_ONLY_CLEANUP = 1;   /* MoE runtime param */
#define ENABLE_STACK_ONLY_CLEANUP P_ENABLE_STACK_ONLY_CLEANUP
#endif
#ifndef STACK_CLEANUP_MIN_ENEMY
static int P_STACK_CLEANUP_MIN_ENEMY = 2;   /* MoE runtime param */
#define STACK_CLEANUP_MIN_ENEMY P_STACK_CLEANUP_MIN_ENEMY
#endif
#ifndef STACK_CLEANUP_MAX_TARGET_ETA
static int P_STACK_CLEANUP_MAX_TARGET_ETA = 10;   /* MoE runtime param */
#define STACK_CLEANUP_MAX_TARGET_ETA P_STACK_CLEANUP_MAX_TARGET_ETA
#endif
#ifndef STACK_CLEANUP_RATIO_NUM
static int P_STACK_CLEANUP_RATIO_NUM = 5;   /* MoE runtime param */
#define STACK_CLEANUP_RATIO_NUM P_STACK_CLEANUP_RATIO_NUM
#endif
#ifndef STACK_CLEANUP_RATIO_DEN
static int P_STACK_CLEANUP_RATIO_DEN = 1;   /* MoE runtime param */
#define STACK_CLEANUP_RATIO_DEN P_STACK_CLEANUP_RATIO_DEN
#endif
#ifndef STACK_CLEANUP_EXTRA_MARGIN
static int P_STACK_CLEANUP_EXTRA_MARGIN = 3;   /* MoE runtime param */
#define STACK_CLEANUP_EXTRA_MARGIN P_STACK_CLEANUP_EXTRA_MARGIN
#endif
#ifndef STACK_CLEANUP_MIN_WAVE
static int P_STACK_CLEANUP_MIN_WAVE = 5;   /* MoE runtime param */
#define STACK_CLEANUP_MIN_WAVE P_STACK_CLEANUP_MIN_WAVE
#endif
#ifndef STACK_CLEANUP_MAX_SEND_EXTRA
static int P_STACK_CLEANUP_MAX_SEND_EXTRA = 0;   /* MoE runtime param */
#define STACK_CLEANUP_MAX_SEND_EXTRA P_STACK_CLEANUP_MAX_SEND_EXTRA
#endif
...
static int P_RETREAT_SIM_DAYS = 49;   /* MoE runtime param */
#define RETREAT_SIM_DAYS P_RETREAT_SIM_DAYS
#endif
#ifndef RETREAT_MAX_UNITS
static int P_RETREAT_MAX_UNITS = 233;   /* MoE runtime param */
#define RETREAT_MAX_UNITS P_RETREAT_MAX_UNITS
#endif
...
static int P_ENABLE_INITIAL_SYNC_CAPTURE = 0;   /* MoE runtime param */
#define ENABLE_INITIAL_SYNC_CAPTURE P_ENABLE_INITIAL_SYNC_CAPTURE
#endif
#ifndef ENABLE_NO_DRIP_ATTACK
static int P_ENABLE_NO_DRIP_ATTACK = 0;   /* MoE runtime param */
#define ENABLE_NO_DRIP_ATTACK P_ENABLE_NO_DRIP_ATTACK
#endif
#ifndef MIN_ATTACK_WAVE_UNITS
static int P_MIN_ATTACK_WAVE_UNITS = 5;   /* MoE runtime param */
#define MIN_ATTACK_WAVE_UNITS P_MIN_ATTACK_WAVE_UNITS
#endif
#ifndef ENABLE_STRICT_SAME_ETA_ATTACK_WAVE
static int P_ENABLE_STRICT_SAME_ETA_ATTACK_WAVE = 1;   /* MoE runtime param */
#define ENABLE_STRICT_SAME_ETA_ATTACK_WAVE P_ENABLE_STRICT_SAME_ETA_ATTACK_WAVE
#endif
...
static int P_RALLY_STACK_STAGE_START_TURN = 75;   /* MoE runtime param */
#define RALLY_STACK_STAGE_START_TURN P_RALLY_STACK_STAGE_START_TURN
#endif
#ifndef RALLY_STACK_HQ_ATTACK_START_TURN
static int P_RALLY_STACK_HQ_ATTACK_START_TURN = 141;   /* MoE runtime param */
#define RALLY_STACK_HQ_ATTACK_START_TURN P_RALLY_STACK_HQ_ATTACK_START_TURN
#endif
#ifndef RALLY_STACK_MIN_LAUNCH_UNITS
static int P_RALLY_STACK_MIN_LAUNCH_UNITS = 4;   /* MoE runtime param */
#define RALLY_STACK_MIN_LAUNCH_UNITS P_RALLY_STACK_MIN_LAUNCH_UNITS
#endif
#ifndef RALLY_STACK_MAX_STAGE_MOVES_PER_TURN
static int P_RALLY_STACK_MAX_STAGE_MOVES_PER_TURN = 26;   /* MoE runtime param */
#define RALLY_STACK_MAX_STAGE_MOVES_PER_TURN P_RALLY_STACK_MAX_STAGE_MOVES_PER_TURN
#endif
#ifndef RALLY_STACK_KEEP_AT_RALLY
static int P_RALLY_STACK_KEEP_AT_RALLY = 1;   /* MoE runtime param */
#define RALLY_STACK_KEEP_AT_RALLY P_RALLY_STACK_KEEP_AT_RALLY
#endif
...
static int P_ANCHOR_ROUTE_START_TURN = 112;   /* MoE runtime param */
#define ANCHOR_ROUTE_START_TURN P_ANCHOR_ROUTE_START_TURN
#endif
...
static int P_ANCHOR_ROUTE_ANCHOR_MODE = 3;   /* MoE runtime param */
#define ANCHOR_ROUTE_ANCHOR_MODE P_ANCHOR_ROUTE_ANCHOR_MODE
#endif
#ifndef ANCHOR_ROUTE_MAX_STAGE_PER_TURN
static int P_ANCHOR_ROUTE_MAX_STAGE_PER_TURN = 14;   /* MoE runtime param */
#define ANCHOR_ROUTE_MAX_STAGE_PER_TURN P_ANCHOR_ROUTE_MAX_STAGE_PER_TURN
#endif
#ifndef ANCHOR_ROUTE_KEEP_EXTRA_AT_SOURCE
static int P_ANCHOR_ROUTE_KEEP_EXTRA_AT_SOURCE = 0;   /* MoE runtime param */
#define ANCHOR_ROUTE_KEEP_EXTRA_AT_SOURCE P_ANCHOR_ROUTE_KEEP_EXTRA_AT_SOURCE
#endif
#ifndef ANCHOR_ROUTE_MAX_STACK
static int P_ANCHOR_ROUTE_MAX_STACK = 20;   /* MoE runtime param */
#define ANCHOR_ROUTE_MAX_STACK P_ANCHOR_ROUTE_MAX_STACK
#endif
#ifndef ANCHOR_ROUTE_LEAVE_AT_ANCHOR
static int P_ANCHOR_ROUTE_LEAVE_AT_ANCHOR = 9;   /* MoE runtime param */
#define ANCHOR_ROUTE_LEAVE_AT_ANCHOR P_ANCHOR_ROUTE_LEAVE_AT_ANCHOR
#endif
#ifndef ANCHOR_ROUTE_USE_ONLY_BASE_ANCHOR
static int P_ANCHOR_ROUTE_USE_ONLY_BASE_ANCHOR = 1;   /* MoE runtime param */
#define ANCHOR_ROUTE_USE_ONLY_BASE_ANCHOR P_ANCHOR_ROUTE_USE_ONLY_BASE_ANCHOR
#endif
...
static int P_ANCHOR_ROUTE_MIN_ATTACKERS = 30;   /* MoE runtime param */
#define ANCHOR_ROUTE_MIN_ATTACKERS P_ANCHOR_ROUTE_MIN_ATTACKERS
#endif
...
static int P_ANCHOR_ROUTE_MIN_OWNED_BASES_TO_ATTACK = 3;   /* MoE runtime param */
#define ANCHOR_ROUTE_MIN_OWNED_BASES_TO_ATTACK P_ANCHOR_ROUTE_MIN_OWNED_BASES_TO_ATTACK
#endif
...
static int P_ANCHOR_ROUTE_START_BASES_A_NUM = 1;   /* MoE runtime param */
#define ANCHOR_ROUTE_START_BASES_A_NUM P_ANCHOR_ROUTE_START_BASES_A_NUM
#endif
#ifndef ANCHOR_ROUTE_START_BASES_A_DEN
static int P_ANCHOR_ROUTE_START_BASES_A_DEN = 3;   /* MoE runtime param */
#define ANCHOR_ROUTE_START_BASES_A_DEN P_ANCHOR_ROUTE_START_BASES_A_DEN
#endif
#ifndef ANCHOR_ROUTE_START_BASES_B
static int P_ANCHOR_ROUTE_START_BASES_B = 0;   /* MoE runtime param */
#define ANCHOR_ROUTE_START_BASES_B P_ANCHOR_ROUTE_START_BASES_B
#endif
#ifndef ANCHOR_ROUTE_STICKY_ANCHOR
static int P_ANCHOR_ROUTE_STICKY_ANCHOR = 0;   /* MoE runtime param */
#define ANCHOR_ROUTE_STICKY_ANCHOR P_ANCHOR_ROUTE_STICKY_ANCHOR
#endif
#ifndef ANCHOR_ROUTE_BUILD_CAPTURED_FIRST
static int P_ANCHOR_ROUTE_BUILD_CAPTURED_FIRST = 1;   /* MoE runtime param */
#define ANCHOR_ROUTE_BUILD_CAPTURED_FIRST P_ANCHOR_ROUTE_BUILD_CAPTURED_FIRST
#endif
#ifndef ANCHOR_ROUTE_RETURN_AFTER_CAPTURE
static int P_ANCHOR_ROUTE_RETURN_AFTER_CAPTURE = 0;   /* MoE runtime param */
#define ANCHOR_ROUTE_RETURN_AFTER_CAPTURE P_ANCHOR_ROUTE_RETURN_AFTER_CAPTURE
#endif
#ifndef ANCHOR_ROUTE_LEAVE_ON_CAPTURE
static int P_ANCHOR_ROUTE_LEAVE_ON_CAPTURE = 7;   /* MoE runtime param */
#define ANCHOR_ROUTE_LEAVE_ON_CAPTURE P_ANCHOR_ROUTE_LEAVE_ON_CAPTURE
#endif
...
static int P_HQ_SAVE_LOOKAHEAD_TURNS = 6;   /* MoE runtime param */
#define HQ_SAVE_LOOKAHEAD_TURNS P_HQ_SAVE_LOOKAHEAD_TURNS
#endif
...
static int P_BASE_DUMMY_HP_DIV = 1;   /* MoE runtime param */
#define BASE_DUMMY_HP_DIV P_BASE_DUMMY_HP_DIV
#endif
#ifndef MAX_COMBAT_SIM_UNITS
#define MAX_COMBAT_SIM_UNITS 256
#endif
#ifndef MAX_CAPTURE_SIM_DAYS
static int P_MAX_CAPTURE_SIM_DAYS = 91;   /* MoE runtime param */
#define MAX_CAPTURE_SIM_DAYS P_MAX_CAPTURE_SIM_DAYS
#endif
#ifndef HQ_SIM_MAX_REINFORCE_DAYS
static int P_HQ_SIM_MAX_REINFORCE_DAYS = 104;   /* MoE runtime param */
#define HQ_SIM_MAX_REINFORCE_DAYS P_HQ_SIM_MAX_REINFORCE_DAYS
#endif
...
static int P_DEFENSE_KEEP_EXTRA_WORKERS = 5;   /* MoE runtime param */
#define DEFENSE_KEEP_EXTRA_WORKERS P_DEFENSE_KEEP_EXTRA_WORKERS
#endif
...
static int P_LATE_TIEBREAK_START_TURN = 152;   /* MoE runtime param */
#define LATE_TIEBREAK_START_TURN P_LATE_TIEBREAK_START_TURN
#endif
#ifndef LATE_TIEBREAK_SAVE_LOOKAHEAD_TURNS
static int P_LATE_TIEBREAK_SAVE_LOOKAHEAD_TURNS = 20;   /* MoE runtime param */
#define LATE_TIEBREAK_SAVE_LOOKAHEAD_TURNS P_LATE_TIEBREAK_SAVE_LOOKAHEAD_TURNS
#endif
...
static int P_CASH_DUMP_TRAIN_START_TURN = 122;   /* MoE runtime param */
#define CASH_DUMP_TRAIN_START_TURN P_CASH_DUMP_TRAIN_START_TURN
#endif
#ifndef CASH_DUMP_MIN_GOLD
static int P_CASH_DUMP_MIN_GOLD = 899;   /* MoE runtime param */
#define CASH_DUMP_MIN_GOLD P_CASH_DUMP_MIN_GOLD
#endif
...
static int P_FINAL_HQ5_CASH_DUMP_START_TURN = 169;   /* MoE runtime param */
#define FINAL_HQ5_CASH_DUMP_START_TURN P_FINAL_HQ5_CASH_DUMP_START_TURN
#endif
#ifndef FINAL_HQ5_HARD_DUMP_START_TURN
static int P_FINAL_HQ5_HARD_DUMP_START_TURN = 195;   /* MoE runtime param */
#define FINAL_HQ5_HARD_DUMP_START_TURN P_FINAL_HQ5_HARD_DUMP_START_TURN
#endif
#ifndef FINAL_HQ5_REPAIR_RESERVE_GOLD
#define FINAL_HQ5_REPAIR_RESERVE_GOLD HQ_HEAL_COST
#endif
#ifndef FINAL_HQ5_MIN_TRAIN_GOLD
static int P_FINAL_HQ5_MIN_TRAIN_GOLD = 97;   /* MoE runtime param */
#define FINAL_HQ5_MIN_TRAIN_GOLD P_FINAL_HQ5_MIN_TRAIN_GOLD
#endif
...
static int P_ARMY_PARITY_MARGIN = -2;   /* MoE runtime param */
#define ARMY_PARITY_MARGIN P_ARMY_PARITY_MARGIN
#endif
#ifndef ARMY_PARITY_EXPANSION_SLACK
static int P_ARMY_PARITY_EXPANSION_SLACK = 0;   /* MoE runtime param */
#define ARMY_PARITY_EXPANSION_SLACK P_ARMY_PARITY_EXPANSION_SLACK
#endif
#ifndef PARITY_MAX_OPP_CAP_RATIO
static int P_PARITY_MAX_OPP_CAP_RATIO = 1;   /* MoE runtime param */
#define PARITY_MAX_OPP_CAP_RATIO P_PARITY_MAX_OPP_CAP_RATIO
#endif
#ifndef OWNED_BASE_RESCUE_EXTRA
static int P_OWNED_BASE_RESCUE_EXTRA = 1;   /* MoE runtime param */
#define OWNED_BASE_RESCUE_EXTRA P_OWNED_BASE_RESCUE_EXTRA
#endif
#ifndef ENABLE_ATTACK_PREDICT
#define ENABLE_ATTACK_PREDICT 1
#endif
#ifndef PREDICT_MIN_GROUP
static int P_PREDICT_MIN_GROUP = 4;   /* MoE runtime param */
#define PREDICT_MIN_GROUP P_PREDICT_MIN_GROUP
#endif
...
static int center_second_base_opening_active(const GameState *S,
  ...
  if (turn > CENTER_SECOND_BASE_MAX_TURN) {
    g_center_split_opening_off = 1;
    return 0;
  }
...
static int center_second_base_pending_to_center_count(const GameState *S,
                                                       const GameMap *M,
                                                       const Actions *a,
                                                       int center) {
  int count = 0;
  for (int i = 0; i < a->moves.len; ++i)
    if (a->moves.data[i].target == center) ++count;
  for (int i = 0; i < S->warriors.len; ++i) {
    const Warrior *w = &S->warriors.data[i];
    if (w->id.side != M->my_side) continue;
    if (w->region == center) {
      ++count;
    } else if (w->state == WSTATE_MOVING && w->target == center) {
      ++count;
    }
  }
  return count;
...
#if CENTER_SECOND_BASE_DOUBLE_CENTER_OPENING
  /* In the double-center variant, the first nearby worker may wait unbuilt
     while we save 300g for center.  Do not dispatch extra nearby workers. */
  for (int i = 0; i < S->warriors.len; ++i) {
    const Warrior *w = &S->warriors.data[i];
    if (w->id.side == M->my_side && w->region != center &&
        is_stronghold(M, w->region) && find_building_const(S, w->region) == NULL)
      return 1;
  }
#endif
...
static int issue_center_split_near_build(Actions *a, const GameState *S,
  ...
  if (*budget < BASE_LEVELS[1].cost) return 0;
  int center = center_second_base_region(M);
#if CENTER_SECOND_BASE_DOUBLE_CENTER_SAVE_GOLD
  /* 97281-2: center is the first 300g build.  The nearby worker may stand on
     the side stronghold, but do not spend the opening base cost there before
     center has been won and built. */
...
static int issue_center_second_base_double_center_claim(Actions *a,
                                                        const GameState *S,
                                                        const GameMap *M,
                                                        const Paths *P,
                                                        int *budget, int turn) {
#if ENABLE_CENTER_SECOND_BASE && CENTER_SECOND_BASE_DOUBLE_CENTER_OPENING
  if (turn > 2) return 0;
  ...
  int have = center_second_base_pending_to_center_count(S, M, a, center);
  int want = CENTER_SECOND_BASE_DOUBLE_CENTER_TARGET_COUNT;
  int did = 0;
  while (have + did < want) {
    ...
    if (!g_center_split_center_sent_once) {
      ...
      if (enemy_eta < my_eta) break;
    }
#endif
    if (!add_move_action(a, S, M, id, center, budget)) break;
    ++did;
...
static int issue_center_split_opening_claims(Actions *a, const GameState *S,
  ...
  did += issue_center_second_base_double_center_claim(a, S, M, P, budget, turn);
  return did;
#else
  (void)a; (void)S; (void)M; (void)P; (void)budget; (void)turn;
  return 0;
...
static int choose_rally_stack_target_and_base(const GameState *S, const GameMap *M,
  ...
  for (int ti = 0; ti < S->buildings.len; ++ti) {
    ...
    for (int ri = 0; ri < S->buildings.len; ++ri) {
      ...
      double home_dist = P->dist[M->my_hq][tb->region];
      ...
      double score = launch_bonus + target_kind + dist +
                     RALLY_STACK_TARGET_HOME_DISTANCE_WEIGHT * home_dist +
...
static int P_BASE_SIM_DEFENSE_THREAT_RADIUS = 1;   /* MoE runtime param */
#define BASE_SIM_DEFENSE_THREAT_RADIUS P_BASE_SIM_DEFENSE_THREAT_RADIUS
#endif
#ifndef OWNED_BASE_CRISIS_RELEASE_RADIUS
static int P_OWNED_BASE_CRISIS_RELEASE_RADIUS = 1;   /* MoE runtime param */
#define OWNED_BASE_CRISIS_RELEASE_RADIUS P_OWNED_BASE_CRISIS_RELEASE_RADIUS
#endif
#ifndef OWNED_BASE_REINFORCE_SOURCE_RADIUS
static int P_OWNED_BASE_REINFORCE_SOURCE_RADIUS = 14;   /* MoE runtime param */
#define OWNED_BASE_REINFORCE_SOURCE_RADIUS P_OWNED_BASE_REINFORCE_SOURCE_RADIUS
#endif
#ifndef OWNED_BASE_MAX_EMERGENCY_PULL
static int P_OWNED_BASE_MAX_EMERGENCY_PULL = 16;   /* MoE runtime param */
#define OWNED_BASE_MAX_EMERGENCY_PULL P_OWNED_BASE_MAX_EMERGENCY_PULL
#endif
#ifndef OWNED_BASE_CRISIS_SIM_DAYS
static int P_OWNED_BASE_CRISIS_SIM_DAYS = 20;   /* MoE runtime param */
#define OWNED_BASE_CRISIS_SIM_DAYS P_OWNED_BASE_CRISIS_SIM_DAYS
#endif
#ifndef HQ_DONOR_KEEP
static int P_HQ_DONOR_KEEP = 1;   /* MoE runtime param */
#define HQ_DONOR_KEEP P_HQ_DONOR_KEEP
#endif
...
static short g_pred_target[PREDICT_MAX_ID];   /* unique predicted target or -1 */
static short g_pred_group[512];               /* movers uniquely aimed at region */

/* engine-exact next hop: argmin over neighbours of w(u,v)+dist(v,t),
   ties -> smaller region number (rulebook "이동 규칙") */
...
static void attack_predict_update(const GameState *S, const GameMap *M,
                                  const Paths *P) {
  for (int r = 0; r < 512; ++r) g_pred_group[r] = 0;
#if ENABLE_ATTACK_PREDICT
  Side opp = opposite(M->my_side);
  ...
  for (int i = 0; i < S->warriors.len; ++i) {
    ...
    seen[num] = 1;
    g_pred_target[num] = -1;
    if (w->state != WSTATE_MOVING) { g_pred_active[num] = 0; continue; }
    int prev = previous_region_of(w->id);
    if (!g_pred_active[num]) {
      /* new movement run: every region is a candidate destination */
      g_pred_active[num] = 1;
      memset(g_pred_cand[num], 1, sizeof(g_pred_cand[num]));
    }
    if (prev >= 0 && prev < P->N && prev != w->region) {
      /* observed hop prev->cur eliminates every destination whose
         engine-exact next hop from prev differs */
    ...
    /* unique MY-building candidate? */
    int uniq = -1, cnt = 0;
    for (int bi = 0; bi < S->buildings.len; ++bi) {
      const Building *b = &S->buildings.data[bi];
      if (b->side != M->my_side) continue;
      int r = b->region;
      if (r < 0 || r >= 512 || !g_pred_cand[num][r]) continue;
      ++cnt; uniq = r;
    }
    if (cnt == 1) {
  ...
  for (int n = 0; n < PREDICT_MAX_ID; ++n)
    if (!seen[n]) g_pred_active[n] = 0;   /* dead units drop out */
#else
...
static int predicted_attacker_eta(const GameState *S, const GameMap *M,
  ...
  if (g_pred_group[region] < PREDICT_MIN_GROUP) return -1;
  return engine_walk_len(P, M, w->region, region);
#else
  (void)S; (void)M; (void)P; (void)w; (void)region;
  return -1;
#endif
}
...
static int P_HQ_SIM_DEFENSE_THREAT_RADIUS = 1;   /* MoE runtime param */
#define HQ_SIM_DEFENSE_THREAT_RADIUS P_HQ_SIM_DEFENSE_THREAT_RADIUS
#endif
#ifndef HQ_SIM_DEFENSE_DAYS
static int P_HQ_SIM_DEFENSE_DAYS = 25;   /* MoE runtime param */
#define HQ_SIM_DEFENSE_DAYS P_HQ_SIM_DEFENSE_DAYS
#endif
#ifndef HQ_SIM_DEFENSE_MAX_RECALL
static int P_HQ_SIM_DEFENSE_MAX_RECALL = 11;   /* MoE runtime param */
#define HQ_SIM_DEFENSE_MAX_RECALL P_HQ_SIM_DEFENSE_MAX_RECALL
#endif
#ifndef HQ_SIM_DEFENSE_TRAIN_CAP
static int P_HQ_SIM_DEFENSE_TRAIN_CAP = 1;   /* MoE runtime param */
#define HQ_SIM_DEFENSE_TRAIN_CAP P_HQ_SIM_DEFENSE_TRAIN_CAP
#endif
...
/* ---- Unsavable-base fallback defense --------------------------------------
   ...
   cannot be saved.  Previously that meant: garrison dies, base falls, and the
   wave rolls to the next base (leaderboard logs 1-66/1-67).  This module makes
   the "unsavable" verdict actionable instead: evacuate the doomed base's
   workers, and concentrate pulls + emergency training at the NEXT owned base
   toward our HQ until the simulation says that fallback line HOLDS. */
#ifndef ENABLE_UNSAVABLE_BASE_FALLBACK
#define ENABLE_UNSAVABLE_BASE_FALLBACK 1
#endif
#ifndef FALLBACK_MAX_PULL
static int P_FALLBACK_MAX_PULL = 3;   /* MoE runtime param */
#define FALLBACK_MAX_PULL P_FALLBACK_MAX_PULL
#endif
#ifndef FALLBACK_TRAIN_CAP
static int P_FALLBACK_TRAIN_CAP = 1;   /* MoE runtime param */
#define FALLBACK_TRAIN_CAP P_FALLBACK_TRAIN_CAP
#endif
...
static int issue_unsavable_base_fallback(Actions *a, const GameState *S,
  ...
  for (int bi = 0; bi < S->buildings.len; ++bi) {
    ...
    /* UNSAVABLE: evacuate the garrison instead of letting it die with the base */
    ...
    /* Hold the fallback line: same wave, rescheduled at its ETA to the fallback */
...
/* ===== MoE expert routing (user 2026-07-06): params by map size =====
   expert 0: N<=63 | expert 1: N<=79 | expert 2: N<=93 | expert 3: N>=95
   expert 0: gen=13 fit=0.918 scores={'m85052': 0.82, 'm83616': 0.94, 'P2': 0.96, 'a23sub': 0.88, 'g15off': 0.99}
   expert 1: gen=8 fit=0.896 scores={'m85052': 0.78, 'm83616': 0.85, 'P2': 0.92, 'a23sub': 0.98, 'g15off': 0.95}
   expert 2: gen=9 fit=0.902 scores={'m85052': 0.8, 'm83616': 0.81, 'P2': 0.98, 'a23sub': 0.92, 'g15off': 1.0}
   expert 3: gen=38 fit=0.872 scores={'m85052': 0.72, 'm83616': 0.79, 'P2': 1.0, 'a23sub': 0.88, 'g15off': 0.97}
*/
static int g_moe_expert = -1;
static void moe_apply_expert_params(int N) {
  int e = (N <= 63) ? 0 : (N <= 79) ? 1 : (N <= 93) ? 2 : 3;
  g_moe_expert = e;
  { static const int t[4] = {260, 215, 163, 185}; P_BUILD_RESERVE = t[e]; }
  { static const int t[4] = {6, 0, 13, 3}; P_EXPANSION_MOVE_RESERVE = t[e]; }
  { static const int t[4] = {1, 1, 1, 1}; P_ENABLE_ENEMY_BASE_CAPTURE = t[e]; }
  { static const int t[4] = {1, 1, 0, 1}; P_ENABLE_ENEMY_HQ_ATTACK = t[e]; }
  { static const int t[4] = {3, 3, 3, 3}; P_NORMAL_EXTRA_GARRISON = t[e]; }
  { static const int t[4] = {90, 93, 60, 79}; P_OPENING_NEUTRAL_FIRST_MAX_TURN = t[e]; }
  { static const int t[4] = {91, 90, 54, 83}; P_OPENING_NEUTRAL_FIRST_TARGET_PERCENT = t[e]; }
  { static const int t[4] = {5, 14, 11, 9}; P_OPENING_NEUTRAL_FIRST_MIN_TARGETS = t[e]; }
  { static const int t[4] = {19, 10, 10, 11}; P_OPENING_NEUTRAL_FIRST_MAX_TARGETS = t[e]; }
  { static const int t[4] = {62, 54, 65, 69}; P_OPENING_RELAX_HQ_KEEP_UNTIL_TURN = t[e]; }
  { static const int t[4] = {0, 30, 0, 0}; P_OPENING_DELAY_HQ_UPGRADE_UNTIL_TURN = t[e]; }
  { static const int t[4] = {0, 6, 0, 0}; P_OPENING_DELAY_HQ_UPGRADE_MIN_HANDLED = t[e]; }
  { static const int t[4] = {108, 119, 108, 81}; P_OPENING_FORCE_ONE_NEUTRAL_PER_TURN_UNTIL = t[e]; }
  { static const int t[4] = {33, 42, 56, 30}; P_OPENING_FORCE_TRAIN_NEUTRAL_UNTIL = t[e]; }
  { static const int t[4] = {50, 53, 58, 60}; P_THIN_OPENING_MAX_TURN = t[e]; }
  { static const int t[4] = {4, 4, 8, 7}; P_THIN_OPENING_RUSH_SAFETY_TURNS = t[e]; }
  { static const int t[4] = {15, 10, 10, 12}; P_OPENING_NEUTRAL_ABORT_ENEMY_MASS_ETA = t[e]; }
  { static const int t[4] = {9, 10, 6, 5}; P_OPENING_NEUTRAL_ABORT_ENEMY_MASS = t[e]; }
  { static const int t[4] = {28, 17, 16, 17}; P_ENDGAME_ATTACK_TURNS = t[e]; }
  { static const int t[4] = {84, 47, 176, 127}; P_ENDGAME_GOLD_SAFETY = t[e]; }
  { static const int t[4] = {172, 172, 169, 175}; P_ENDGAME_SYNC_START_TURN = t[e]; }
  { static const int t[4] = {196, 150, 198, 196}; P_ENDGAME_SYNC_ARRIVAL_TURN = t[e]; }
  { static const int t[4] = {0, 1, 0, 0}; P_ENABLE_FORWARD_STAGING = t[e]; }
  { static const int t[4] = {4, 3, 1, 6}; P_FORWARD_STAGING_MAX_PER_SOURCE = t[e]; }
  { static const int t[4] = {10, 9, 8, 2}; P_FORWARD_STAGING_EXTRA_CAP = t[e]; }
  { static const int t[4] = {1, 1, 1, 1}; P_ENABLE_HOME_DEFENSE = t[e]; }
  { static const int t[4] = {0, 0, 0, 0}; P_DEFENSE_SAFETY_MARGIN = t[e]; }
  { static const int t[4] = {1, 1, 1, 1}; P_DEFENSE_IMMEDIATE_RADIUS = t[e]; }
  { static const int t[4] = {5, 6, 11, 10}; P_DEFENSE_HARD_ETA = t[e]; }
  { static const int t[4] = {1, 0, 1, 4}; P_DEFENSE_RECALL_EXTRA = t[e]; }
  { static const int t[4] = {0, 1, 1, 1}; P_HARD_DEFENSE_SKIPS_ECONOMY_MOVES = t[e]; }
  { static const int t[4] = {4, 5, 3, 4}; P_DEFENSE_KEEP_EXTRA_WORKERS = t[e]; }
  { static const int t[4] = {0, 0, 0, 1}; P_ENABLE_STACK_ONLY_GUARD = t[e]; }
  { static const int t[4] = {2, 4, 4, 1}; P_STACK_DANGER_COUNT = t[e]; }
  { static const int t[4] = {7, 10, 10, 16}; P_STACK_LOOKAHEAD = t[e]; }
  { static const int t[4] = {5, 2, 5, 5}; P_STACK_TARGET_DANGER_COUNT = t[e]; }
  { static const int t[4] = {0, 1, 1, 0}; P_ENABLE_STACK_ONLY_CLEANUP = t[e]; }
  { static const int t[4] = {2, 2, 3, 2}; P_STACK_CLEANUP_MIN_ENEMY = t[e]; }
  { static const int t[4] = {18, 10, 9, 14}; P_STACK_CLEANUP_MAX_TARGET_ETA = t[e]; }
  { static const int t[4] = {5, 5, 2, 5}; P_STACK_CLEANUP_RATIO_NUM = t[e]; }
  { static const int t[4] = {1, 1, 2, 1}; P_STACK_CLEANUP_RATIO_DEN = t[e]; }
  { static const int t[4] = {0, 3, 0, 0}; P_STACK_CLEANUP_EXTRA_MARGIN = t[e]; }
  { static const int t[4] = {3, 5, 4, 6}; P_STACK_CLEANUP_MIN_WAVE = t[e]; }
  { static const int t[4] = {4, 0, 5, 4}; P_STACK_CLEANUP_MAX_SEND_EXTRA = t[e]; }
  { static const int t[4] = {0, 0, 0, 1}; P_ENABLE_INITIAL_SYNC_CAPTURE = t[e]; }
  { static const int t[4] = {1, 0, 0, 1}; P_ENABLE_NO_DRIP_ATTACK = t[e]; }
  { static const int t[4] = {5, 5, 5, 5}; P_MIN_ATTACK_WAVE_UNITS = t[e]; }
  { static const int t[4] = {1, 1, 0, 1}; P_ENABLE_STRICT_SAME_ETA_ATTACK_WAVE = t[e]; }
  { static const int t[4] = {62, 75, 70, 57}; P_RALLY_STACK_STAGE_START_TURN = t[e]; }
  { static const int t[4] = {143, 141, 102, 129}; P_RALLY_STACK_HQ_ATTACK_START_TURN = t[e]; }
  { static const int t[4] = {4, 4, 4, 4}; P_RALLY_STACK_MIN_LAUNCH_UNITS = t[e]; }
  { static const int t[4] = {27, 26, 29, 29}; P_RALLY_STACK_MAX_STAGE_MOVES_PER_TURN = t[e]; }
  { static const int t[4] = {0, 1, 1, 1}; P_RALLY_STACK_KEEP_AT_RALLY = t[e]; }
  { static const int t[4] = {7, 6, 4, 4}; P_HQ_SAVE_LOOKAHEAD_TURNS = t[e]; }
  { static const int t[4] = {1, 1, 1, 1}; P_BASE_DUMMY_HP_DIV = t[e]; }
  { static const int t[4] = {94, 91, 64, 72}; P_MAX_CAPTURE_SIM_DAYS = t[e]; }
  { static const int t[4] = {53, 104, 49, 115}; P_HQ_SIM_MAX_REINFORCE_DAYS = t[e]; }
  { static const int t[4] = {152, 152, 158, 176}; P_LATE_TIEBREAK_START_TURN = t[e]; }
  { static const int t[4] = {31, 20, 70, 26}; P_LATE_TIEBREAK_SAVE_LOOKAHEAD_TURNS = t[e]; }
  { static const int t[4] = {132, 122, 126, 143}; P_CASH_DUMP_TRAIN_START_TURN = t[e]; }
  { static const int t[4] = {991, 899, 991, 1200}; P_CASH_DUMP_MIN_GOLD = t[e]; }
  { static const int t[4] = {170, 169, 167, 174}; P_FINAL_HQ5_CASH_DUMP_START_TURN = t[e]; }
  { static const int t[4] = {172, 195, 174, 197}; P_FINAL_HQ5_HARD_DUMP_START_TURN = t[e]; }
  { static const int t[4] = {219, 97, 77, 218}; P_FINAL_HQ5_MIN_TRAIN_GOLD = t[e]; }
  { static const int t[4] = {5, 7, 3, 1}; P_HP_RATIO_TRAIN_PRIORITY_X_NUM = t[e]; }
  { static const int t[4] = {1, 1, 3, 2}; P_HP_RATIO_TRAIN_PRIORITY_X_DEN = t[e]; }
  { static const int t[4] = {11, 2, 12, 8}; P_HP_RATIO_TRAIN_PRIORITY_MIN_ENEMY_HP = t[e]; }
  { static const int t[4] = {158, 121, 147, 146}; P_HP_RATIO_TRAIN_PRIORITY_MAX_TURN = t[e]; }
  { static const int t[4] = {4, 2, 3, 2}; P_HP_RATIO_TRAIN_PRIORITY_MAX_PER_TURN = t[e]; }
  { static const int t[4] = {1, 1, 1, 1}; P_OWNED_BASE_CRISIS_RELEASE_RADIUS = t[e]; }
  { static const int t[4] = {24, 20, 31, 28}; P_OWNED_BASE_CRISIS_SIM_DAYS = t[e]; }
  { static const int t[4] = {17, 16, 15, 16}; P_OWNED_BASE_MAX_EMERGENCY_PULL = t[e]; }
  { static const int t[4] = {14, 14, 9, 9}; P_OWNED_BASE_REINFORCE_SOURCE_RADIUS = t[e]; }
  { static const int t[4] = {54, 49, 25, 52}; P_RETREAT_SIM_DAYS = t[e]; }
  { static const int t[4] = {227, 233, 249, 111}; P_RETREAT_MAX_UNITS = t[e]; }
  { static const int t[4] = {144, 112, 175, 144}; P_ANCHOR_ROUTE_START_TURN = t[e]; }
  { static const int t[4] = {2, 3, 0, 3}; P_ANCHOR_ROUTE_ANCHOR_MODE = t[e]; }
  { static const int t[4] = {12, 14, 9, 24}; P_ANCHOR_ROUTE_MAX_STAGE_PER_TURN = t[e]; }
  { static const int t[4] = {7, 0, 13, 18}; P_ANCHOR_ROUTE_KEEP_EXTRA_AT_SOURCE = t[e]; }
  { static const int t[4] = {49, 20, 32, 29}; P_ANCHOR_ROUTE_MAX_STACK = t[e]; }
  { static const int t[4] = {2, 9, 1, 10}; P_ANCHOR_ROUTE_LEAVE_AT_ANCHOR = t[e]; }
  { static const int t[4] = {0, 1, 0, 1}; P_ANCHOR_ROUTE_USE_ONLY_BASE_ANCHOR = t[e]; }
  { static const int t[4] = {20, 30, 22, 22}; P_ANCHOR_ROUTE_MIN_ATTACKERS = t[e]; }
  { static const int t[4] = {0, 3, 3, 2}; P_ANCHOR_ROUTE_MIN_OWNED_BASES_TO_ATTACK = t[e]; }
  { static const int t[4] = {0, 1, 9, 0}; P_ANCHOR_ROUTE_START_BASES_A_NUM = t[e]; }
  { static const int t[4] = {1, 3, 1, 2}; P_ANCHOR_ROUTE_START_BASES_A_DEN = t[e]; }
  { static const int t[4] = {0, 0, 2, 0}; P_ANCHOR_ROUTE_START_BASES_B = t[e]; }
  { static const int t[4] = {1, 7, 8, 7}; P_ANCHOR_ROUTE_LEAVE_ON_CAPTURE = t[e]; }
  { static const int t[4] = {1, 1, 1, 0}; P_ANCHOR_ROUTE_BUILD_CAPTURED_FIRST = t[e]; }
  { static const int t[4] = {0, 0, 1, 1}; P_ANCHOR_ROUTE_RETURN_AFTER_CAPTURE = t[e]; }
  { static const int t[4] = {1, 0, 0, 0}; P_ANCHOR_ROUTE_STICKY_ANCHOR = t[e]; }
  { static const int t[4] = {2, 1, 7, 3}; P_HQ_SIM_DEFENSE_THREAT_RADIUS = t[e]; }
  { static const int t[4] = {37, 25, 22, 8}; P_HQ_SIM_DEFENSE_DAYS = t[e]; }
  { static const int t[4] = {5, 11, 13, 19}; P_HQ_SIM_DEFENSE_MAX_RECALL = t[e]; }
  { static const int t[4] = {2, 1, 3, 3}; P_HQ_SIM_DEFENSE_TRAIN_CAP = t[e]; }
  { static const int t[4] = {1, 1, 1, 1}; P_BASE_SIM_DEFENSE_THREAT_RADIUS = t[e]; }
  { static const int t[4] = {9, 3, 9, 6}; P_FALLBACK_MAX_PULL = t[e]; }
  { static const int t[4] = {3, 1, 2, 3}; P_FALLBACK_TRAIN_CAP = t[e]; }
  { static const int t[4] = {1, 1, 1, 1}; P_HQ_DONOR_KEEP = t[e]; }
  { static const int t[4] = {-1, -2, -1, 0}; P_ARMY_PARITY_MARGIN = t[e]; }
  { static const int t[4] = {0, 0, 0, 0}; P_ARMY_PARITY_EXPANSION_SLACK = t[e]; }
  { static const int t[4] = {1, 1, 1, 2}; P_PARITY_MAX_OPP_CAP_RATIO = t[e]; }
  { static const int t[4] = {2, 1, 1, 0}; P_OWNED_BASE_RESCUE_EXTRA = t[e]; }
  { static const int t[4] = {4, 4, 6, 3}; P_PREDICT_MIN_GROUP = t[e]; }
}
...
int main(void) {
  ...
  moe_apply_expert_params(M.N);   /* MoE routing */
